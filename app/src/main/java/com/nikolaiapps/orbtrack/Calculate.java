...
public abstract class Calculate
{
    ...
    public static abstract class Passes
    {
        ...
        public static class Item extends CalculateService.PassData
        {
            ...
            private Item(int index, double azStart, double azEnd, double azTravel, double elMax, double closestAz, double closetEl, boolean calculating, boolean foundPass, boolean finishedCalculating, boolean foundPassStart, boolean showPassEnd, boolean usePathProgress, boolean usePassQuality, boolean hideUnknownPasses, Calendar startTime, Calendar endTime, String duration, Parcelable[] views, Parcelable[] views2, Calculations.SatelliteObjectType sat, Calculations.SatelliteObjectType sat2, double illumination, String phaseName, boolean tleAccurate)
            {
                super(index, azStart, azEnd, azTravel, elMax, closestAz, closetEl, calculating, foundPass, finishedCalculating, foundPassStart, showPassEnd, usePathProgress, usePassQuality, hideUnknownPasses, startTime, endTime, duration, views, views2, sat, sat2, illumination, phaseName);
            ...
            {
                this(index, Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE, false, false, false, false, true, usePathProgress, usePassQuality, hideUnknownPasses, null, null, "", null, null, (currentSatellite != null ? currentSatellite.satellite : null), null, 0, null, false);
                isLoading = loading;
